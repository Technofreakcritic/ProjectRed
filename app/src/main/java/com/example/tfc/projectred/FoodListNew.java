...
public class FoodListNew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.add(new itemnew(R.drawable.dinner,"Steak ",R.drawable.dinner,2500));
        mList.add(new itemnew(R.drawable.breakfast,"Pancake Set",R.drawable.breakfast,4000));
        mList.add(new itemnew(R.drawable.recipe_group,"Desert",R.drawable.email_ad,1200));
        mList.add(new itemnew(R.drawable.recipe_group_1,"Chocolate",R.drawable.email_ad,3200));
        ...
        mList.add(new itemnew(R.drawable.tomatos,"Velvet cupcake",R.drawable.email_ad,3400));
